...
class TTS_wrapper:
    ...
    def get_audio(self, script: object, model: str = "tts-1") -> Path:
        ...
        concatenated_audio_path = self._concate_audio(files)
        return concatenated_audio_path
        
    def _concate_audio(self, files, output_path: str = "combined_speech.mp3"):
